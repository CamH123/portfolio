...
export default function StickyNote() {
    ...
    return (
        <aside className={`magazine-note-entrance @container pointer-events-none absolute left-[8%] top-[10%] z-20 hidden aspect-square w-[20%] min-h-0 overflow-hidden bg-mag-amber p-[1.5cqw] font-sticky-note text-mag-black transition-opacity ease-out sm:block ${isCoverNoteVisible ? "opacity-100 duration-500" : "opacity-0 duration-200"}`}>
